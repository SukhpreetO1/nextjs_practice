...
const CardWithDetail = ({ image_src, image_name, content, index, title }) => {
        ...
        <>
            <div>
                <div className="dashboard_card_section flex mx-8">
                    ...
                    <div className={`dashboard_content mt-10 text-justify mr-8 text-xl font-light w-full lg:w-4/5 ${isEven ? 'order-2' : 'order-1'}`}>
