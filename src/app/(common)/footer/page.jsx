...
const Footer = () => {
  return (
    <>
        <section>
            <div className='footer_content flex mt-14 bg-gray-200 h-32'>
                <div className='footer_text text-justify  pt-4 px-5'>
                ...
                <div className='footer_text text-justify  pt-4 px-5 bg-gray-100'>
